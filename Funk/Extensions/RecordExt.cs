...
public static class RecordExt
{
    extension<T1>(Task<Record<T1>> record)
    {
        ...
        public async Task<Record<R1>> FlatMapAsync<R1>(Func<T1, Task<Record<R1>>> selector) => await (await record.ConfigureAwait(false)).FlatMapAsync(selector).ConfigureAwait(false);
        ...
        /// <returns>A Task containing the new Record of 1.</returns>
        public async Task<Record<R1>> MapAsync<R1>(Func<T1, Task<R1>> selector) => await (await record.ConfigureAwait(false)).MapAsync(selector).ConfigureAwait(false);
    }
    ...
    extension<T1, T2>(Task<Record<T1, T2>> record)
    {
        ...
        public async Task<Record<R1, R2>> FlatMapAsync<R1, R2>(Func<T1, T2, Task<Record<R1, R2>>> selector) => await (await record.ConfigureAwait(false)).FlatMapAsync(selector).ConfigureAwait(false);
        ...
        /// <returns>A Task containing the new Record of 2.</returns>
        public async Task<Record<R1, R2>> MapAsync<R1, R2>(Func<T1, T2, Task<(R1, R2)>> selector) => await (await record.ConfigureAwait(false)).MapAsync(selector).ConfigureAwait(false);
    }
    ...
    extension<T1, T2, T3>(Task<Record<T1, T2, T3>> record)
    {
        ...
        public async Task<Record<R1, R2, R3>> FlatMapAsync<R1, R2, R3>(Func<T1, T2, T3, Task<Record<R1, R2, R3>>> selector) => await (await record.ConfigureAwait(false)).FlatMapAsync(selector).ConfigureAwait(false);
        ...
        /// <param name="selector">The asynchronous function to transform the Record elements.</param>
        /// <returns>A Task containing the new Record of 3.</returns>
        public async Task<Record<R1, R2, R3>> MapAsync<R1, R2, R3>(Func<T1, T2, T3, Task<(R1, R2, R3)>> selector) => await (await record.ConfigureAwait(false)).MapAsync(selector).ConfigureAwait(false);
    }
    ...
    extension<T1, T2, T3, T4>(Task<Record<T1, T2, T3, T4>> record)
    {
        ...
        public async Task<Record<R1, R2, R3, R4>> FlatMapAsync<R1, R2, R3, R4>(Func<T1, T2, T3, T4, Task<Record<R1, R2, R3, R4>>> selector) => await (await record.ConfigureAwait(false)).FlatMapAsync(selector).ConfigureAwait(false);
        ...
        /// <param name="selector">The asynchronous function to transform the Record elements.</param>
        /// <returns>A Task containing the new Record of 4.</returns>
        public async Task<Record<R1, R2, R3, R4>> MapAsync<R1, R2, R3, R4>(Func<T1, T2, T3, T4, Task<(R1, R2, R3, R4)>> selector) => await (await record.ConfigureAwait(false)).MapAsync(selector).ConfigureAwait(false);
    }
    ...
    extension<T1, T2, T3, T4, T5>(Task<Record<T1, T2, T3, T4, T5>> record)
    {
        ...
        public async Task<Record<R1, R2, R3, R4, R5>> FlatMapAsync<R1, R2, R3, R4, R5>(Func<T1, T2, T3, T4, T5, Task<Record<R1, R2, R3, R4, R5>>> selector) => await (await record.ConfigureAwait(false)).FlatMapAsync(selector).ConfigureAwait(false);
        ...
        /// <param name="selector">The asynchronous function to transform the Record elements.</param>
        /// <returns>A Task containing the new Record of 5.</returns>
        public async Task<Record<R1, R2, R3, R4, R5>> MapAsync<R1, R2, R3, R4, R5>(Func<T1, T2, T3, T4, T5, Task<(R1, R2, R3, R4, R5)>> selector) => await (await record.ConfigureAwait(false)).MapAsync(selector).ConfigureAwait(false);
    }
